...
from constants import dataset_yaml_path, yolo_pretrained_model, yolo_model_config, yolo_model_path, yolo_model_name
...
if __name__ == '__main__':
    ...
    results = model.train(
        ...
        name=yolo_model_name,  # experiment name
    )
