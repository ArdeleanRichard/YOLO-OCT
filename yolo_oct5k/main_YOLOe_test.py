...
if __name__ == "__main__":
    ...
    test_dataset = YOLOtoSegmentationDataset("../" + data_root + "yolo_SEG/", image_size=512, split="test")
    test_loader = DataLoader(test_dataset, batch_size=4, shuffle=False)

    # Evaluate the model
    metrics = evaluate_model_box_mask(model, dataset_SEG_yaml_path, test_loader, device, conf=0.15)
